...
sendVarToJS('eqType', 'telegram');
$eqLogics = eqLogic::byType('telegram');
        ...
        <span style="font-size : 1.1em;position:relative; top : 15px;word-break: break-all;white-space: pre-wrap;word-wrap: break-word;"><center>Ajouter</center></span>
                ...
                foreach ($eqLogics as $eqLogic) {
                  $opacity = ($eqLogic->getIsEnable()) ? '' : jeedom::getConfiguration('eqLogic:style:noactive');
                    ...
                    echo "<center>";
                    echo '<img src="plugins/telegram/doc/images/telegram_icon.png" height="105" width="95" />';
                    echo "</center>";
    ...
    <form class="form-horizontal">
      <fieldset>
        ...
        <div class="form-group">
          <label class="col-sm-2 control-label">{{Nom de l'équipement Telegram}}</label>
          <div class="col-sm-3">
...
<div class="form-group">
       <label class="col-sm-2 control-label">{{Créer les nouveaux contacts}}</label>
        <div class="col-sm-3">
...
<br>
  <table id="table_cmd" class="table table-bordered table-condensed">
    <thead>
      <tr>
        <th>{{Nom}}</th><th>{{Chat Id / Valeur}}</th><th>{{Username}}</th><th></th><th>{{Options}}</th>
      </tr>
    </thead>
    <tbody>
    </tbody>
